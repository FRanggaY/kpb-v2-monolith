<div class="card">
    <div class="modal-body">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="user-tab" data-toggle="tab" href="#user" role="tab" aria-controls="user" aria-selected="true">Advertise</a>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="user" role="tabpanel" aria-labelledby="user-tab">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="{{ $data->link }}" name="link" class="form-control" placeholder="link">
                    </div>
                </div>
                <div class="form-group row">
