<div class="card" class="modal-part" id="modal-add-gallery" >
    <div class="card-body">
        <form method="POST" action="{{ url('dashboard/gallery') }}" class="gallery-form" enctype="multipart/form-data">
            @csrf
            <div class="form-section">
                <div class="form-group">
                    <label class="col-form-label">Create gallery</label>
                </div>
